...
const Stripe = () => {
  return (
    <div className=" w-full text-white bg-black text-xs">
...
export default function Navbar() {
  return (
    <section className="text-gray-700 bg-white nav relative shadow-md">
      <Stripe />
      <Popover className="max-w-7xl mx-auto">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="flex items-center justify-between md:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden md:flex">
              <Link
                href="/about"
                className="text-base font-semibold uppercase hover:bg-black hover:text-white py-4 px-8 trans"
              >
                About Wisdom
              </Link>
              <Link
        ...
        >
          <Popover.Panel
            focus
            className="bg-[#0d0e18] text-white absolute inset-x-0 top-0 origin-top-right transform transition md:hidden border border-gray-400 rounded mx-2"
          >
            <div className="rounded-lg shadow-lg ">
              ...
              <div className="space-y-6 py-6 px-5">
                <div className="flex flex-col  gap-6">
                  <Link
                    href="/about"
                    className="text-base font-medium text-gray-200 hover:text-gray-200"
                  >
                    <Popover.Button>About Wisdom</Popover.Button>
                  </Link>
                  <Link
                    href="/company"
                    className="text-base font-medium text-gray-200 hover:text-gray-200"
                  >
                    <Popover.Button>The Pertinence Way</Popover.Button>
                  </Link>
                  <Link
                    href="/contact"
                    className="text-base font-medium text-gray-200 hover:text-gray-200"
