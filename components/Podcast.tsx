...
const Podcast = () => {
    return (
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 items-center min-h-[50vh] py-20 px-6 md:px-0 max-w-7xl mx-auto mt-20'>
            ...
            <div className='col-span-1 flex flex-col items-center justify-center'>
                <div className='relative w-full  md:rounded-lg overflow-hidden group'>
                    <Image src={wisdom2} alt='wisdom' priority placeholder='blur' className='h-full w-full object-center object-cover' />
                </div>
            </div>
